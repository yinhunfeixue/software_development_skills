...
2. Install the skill: `npx skills add yinhunfeixue/software_development_skills --all`
3. Get started:
   - Type `load skill` in chat
   - Then describe your requirement, e.g. `I want to create a news website`
